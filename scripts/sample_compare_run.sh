...
set -e 
#../scripts/compare_vector_matches_wtaxa.pl --input_summary ../test-files/sample_input_final_step.txt  --input_taxa ../info-files/taxonomy_tree_wlevels.txt --input_artificial_vectors ../info-files/artificial_whole_sequences.txt --input_artificial_segments ../info-files/artificial_intervals.txt --input_univec_sources ../info-files/biological_exclusions.txt  --input_amr ../info-files/UniVec10_vs_amr_distinct_intervals.txt --input_sequences ../test-files/sample_candidates.fa --outfile my_output_final_step.txt
...
diff -w ../test-files/sample_output_final_step.txt my_output_final_step.txt
